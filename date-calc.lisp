...
;;; May 2nd, 2006 Not critical Typo corrected (Thanks to Claus Brunzema):
;;; Orig:       (defparameter eopoc (+ year-of-epoc century-of-epoc) "reference year (epoc)")
;;; Corrected:  (defparameter epoc  (+ year-of-epoc century-of-epoc) "reference year (epoc)")
...
(defparameter epoc (+ year-of-epoc century-of-epoc) "reference year (epoc)")
